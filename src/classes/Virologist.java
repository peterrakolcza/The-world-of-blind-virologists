...
public class Virologist {
    ...
    private double protectection = 0;
    ...
    /**A Virologus letrehozott agenteit tartalmazo listahoz hozzadodik a parameterkent kapott agent*/
    ...
    private void Root(Virologist target) {
        target.rooted = true;
    }

    public void MoveRandomly(Virologist target) {
        target.randommoves = true;
    }


    public void Move(Field next) {
        /**Ellenorzese annak hogy a virologus tud e mozogni a parameterkent megkapott mezore*/
    ...
    /**A virologist felveszi a storage mezorol az ott levo amino es nucleotidokat es hozzadodik a jelenlegi anyagjaihoz*/
